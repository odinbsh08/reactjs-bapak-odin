...
let API_KEY = 'AIzaSyCmmPY5vbCVIbQeFKT5ld8Ly2xisG-BcSw';
...
form.onsubmit = async (ev) => {
  ...
  try {
    ...
    for await (let response of result.stream) {
      ...
      output.innerHTML = md.render(khodamDescription); // Output is rendered in the center
    }
